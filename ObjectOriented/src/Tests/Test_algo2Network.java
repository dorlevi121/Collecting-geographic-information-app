...
public class Test_algo2Network extends TestCase {
	...
	double Signal1 = -83;
	private algo2Network a2n=new algo2Network(SSID, MAC, Signal1);
	/**
	 * Test for  getSSID in weightedCenterPoint.algo2Network
	 */
	@Test
	public void test_getSSID() {
		assertEquals("Ariel_University",a2n.getSSID());
	}
	/**
