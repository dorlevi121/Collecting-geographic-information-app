...
import main.java.CSV.makeCSV;
import main.java.Filters.Filter;
import main.java.Filters.FilterGPS;
import main.java.Filters.FilterID;
import main.java.Filters.FilterMAC;
import main.java.Filters.FilterTime;
import main.java.Filters.filterList;
import main.java.GPSPoints.GPSPoint;
import main.java.Kml.kml;
import main.java.MainWatch.watch;
import main.java.SQL.MySQL;
import main.java.Wifi.WiFi;
import main.java.org.eclipse.wb.swing.FocusTraversalOnArray;
import main.java.weightedCenterPoint.Algo_2Function;
import main.java.weightedCenterPoint.Line_Algo2;
import main.java.weightedCenterPoint.algo1;
		...
		btnRun.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				...
				//By GPS and time
					...
					filter = new FilterGPS(StartLon, StartLat, EndLon,  EndLat);
					List<Line_Algo2> filteredList1 = filterList.filterList1(filteredList,filter);
